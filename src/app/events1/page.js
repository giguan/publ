...
return (
    ...
    {/* Header 부분 */}
    <div
        className="flex justify-between items-center bg-gradient-to-r from-blue-500 to-blue-800 p-4 cursor-pointer h-20"
        onClick={toggleCollapse}
        style={{
            backgroundImage: `url('/images/고챔스디자인.png')`,
    ...
    <div
        ...
        style={{
            backgroundImage: `url('/images/고챔스상세디자인.png')`,
    ...
    ></div>
        ...
        {/* 추가적인 하단 정보 */}
        <div className="p-4 bg-gray-800 text-center text-white flex justify-center items-center space-x-6">
            <div className="font-bold">지금 당장 예선에 참가하세요</div>
            <div className="text-white" onClick={toggleCollapse}>
                {isOpen ? 
...
const CollapseComponent2 = () => {
    ...
    return (
        ...
        <div
            ...
            onClick={toggleCollapse}
            style={{
                backgroundImage: `url('/images/신규가입이벤트.png')`,
                backgroundSize: 'cover', // 이미지를 컨테이너에 맞게 조정
                backgroundPosition: 'center', // 이미지를 중앙에 배치
            }}
        >
...
const CollapseComponent3 = () => {
    ...
    return (
        ...
        <div
            ...
            onClick={toggleCollapse}
            style={{
                backgroundImage: `url('/images/와일드슬릇 이벤트.png')`,
                backgroundSize: 'cover', // 이미지를 컨테이너에 맞게 조정
                backgroundPosition: 'center', // 이미지를 중앙에 배치
            }}
        >
