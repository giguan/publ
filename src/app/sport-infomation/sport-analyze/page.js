...
export const SportsDashboard = () => {
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 rounded-lg shadow-md border p-4 bg-white">
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex space-x-2 items-center text-left m-2 hover:scale-[1.1] duration-300 transform">
            ...
            {/* 전문가 리스트 그리드 */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 3xl:grid-cols-3 gap-4">
              {[
                {
                  name: "픽주는강아지",
                  role: "LCK 전문가",
                  image: "/images/users-profile/강아지.jpg",
                  description: "LCK, LPL, LCS 분석가",
                },
                {
                  name: "현아",
                  role: "LCK 전문가",
                  image: "/images/users-profile/강직원.jpg",
                  description: "LCK, LPL, LCS 분석가",
                },
                {
                  name: "홍아저씨",
                  role: "LCK 전문가",
                  image: "/images/users-profile/지수.jpg",
                  description: "LCK, LPL, LCS 분석가",
                },
                {
                  name: "픽주는고양이",
                  role: "LCK 전문가",
                  image: "/images/users-profile/현아.jpg",
                  description: "LCK, LPL, LCS 분석가",
                },
                {
                  name: "현아",
                ...
                <div key={index} className="flex space-x-4 items-center p-2 border rounded-lg hover:scale-[1.1] duration-300 transform">
                    <img src={item.image} alt={item.name} className="w-16 h-16 rounded-full object-cover" />
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-1">
                            <h3 className="text-sm font-bold text-gray-800 truncate max-w-[80%]">
                                {item.name}
                            </h3>
                        </div>
                        <p className="text-[8px] text-gray-500 flex-shrink-0">| {item.role}</p> 
          ...
          <div className="flex-1 bg-white rounded-lg border shadow-md p-4">
            ...
            <ul className="space-y-4">
              {[
                {
                  title: "야구대장⭐ 오후야구 최다연승",
                  votes: 30,
                  comments: 14,
                },
                { title: "차두리 해설 491배 적중 후 공유", votes: 30, comments: 14 },
                {
                  title: "픽주는아재 승급기념 유료픽 공유",
                  votes: 30,
                  comments: 14,
                },
                {
                  title: "새벽 복구픽 원금회복하고 다시 도전!",
                  votes: 30,
                  comments: 14,
                },
                {
                  title: "새벽 복구픽 원금회복하고 다시 도전222!",
                  votes: 30,
                  comments: 14,
                },
              ].map((item, index) => (
                <li
                  key={index}
                  className="flex justify-between items-center p-2 hover:scale-[1.1] duration-300 transform"
                >
  ...
  const EPLTabs = () => {
    ...
    return (
    <div className="w-[95vw] max-w-screen-lg mx-auto px-4">
        <Swiper
          spaceBetween={1} // 슬라이드 간격을 최대한 줄임
          slidesPerView={8} // 기본적으로 8개의 슬라이드를 보이게 설정
          navigation={true} // 화살표 네비게이션 추가
          modules={[Navigation]} // 모듈 추가
          className="mySwiper"
          breakpoints={{
            1920: {
          ...
          {teams.map((team, index) => (
            <SwiperSlide key={index}>
              <button
                ...
                className={`p-2 flex items-center justify-center rounded-lg bg-white hover:scale-[1.2] duration-300 transform ${
                  activeTab === team.name
        ...
        <div className="flex space-x-4">
          {leagues.map((league) => (
            <button
              ...
              className={`flex items-center justify-center p-2 border text-gray-600 font-bold hover:scale-[1.2] duration-300 transform${
        ...
        <div className="relative flex-col justify-between items-center p-4 rounded-lg">
            <div className="relative w-full mx-auto flex justify-between items-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center bottom-6 z-0 ">
                    <svg xmlns="http://www.w3.org/2000/svg" width="890" height="58" viewBox="0 0 890 58" fill="none" className="rounded-full w-[46vw]">
